...
public class PhotoSelectorActivity extends Activity implements
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode !=0){
            ...
            onTakedPhoto(requestCode,resultCode,data);
        }
    }
...
//        ImagePickerUtils.launchActivity(this, PhotoPreviewActivity.class, bundle);
    ...
    public void onItemClick(int position) {
        ...
        bundle.putSerializable("all", mPhotoAdapter.getItems());
    ...
    protected void onTakedPhoto(int requestCode,int resultcode,Intent data) {
