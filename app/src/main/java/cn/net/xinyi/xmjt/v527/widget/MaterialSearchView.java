...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            ...
            boolean supportBack = a.getBoolean(R.styleable.MaterialSearchView_searchSupportBack, true);
            mBackBtn.setVisibility(supportBack ? VISIBLE : GONE);

            int padding = (int) a.getDimension(R.styleable.MaterialSearchView_searchPadding, SizeUtils.dp2px(5));
            mSearchSrcTextView.setPadding(padding, 0, padding, 0);

            boolean defaultOpen = a.getBoolean(R.styleable.MaterialSearchView_searchDefaultOpen, false);
            mSearchLayout.setVisibility((defaultOpen ? VISIBLE : GONE));
    ...
    private void initiateView() {
        ...
        loadingView = (AVLoadingIndicatorView) mSearchLayout.findViewById(R.id.avi_loading);
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    if (mOnQueryChangeListener != null) {
                        mOnQueryChangeListener.onQueryTextChange(mSearchSrcTextView.getText().toString());
                    }
    ...
    private void onTextChanged(CharSequence newText) {
        ...
        if (mOnQueryChangeListener != null && !TextUtils.equals(newText, mOldQueryText) && mSearchSrcTextView.isFocused()) {
    ...
    /**
     * Call this method to show suggestions list. This shows up when adapter is set.before calling this.
     */
    ...
    public void refreshLoading(boolean loading) {
        if (loading) {
