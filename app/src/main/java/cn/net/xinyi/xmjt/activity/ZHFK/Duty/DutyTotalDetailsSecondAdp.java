 ...
 */
public class DutyTotalDetailsSecondAdp extends BaseAdapter {

    private JSONArray data=null;
    private Context context;
    public DutyTotalDetailsSecondAdp(Context context, JSONArray data) {
...
//        ZHSJ:最后操作时间
        ...
        String  DISTANCE = ((JSONObject)data.get(position)).getString("DISTANCE");
        //不在巡逻状态下，24小时内巡逻数据
        ...
        viewHolde.tv_cjrs.setText(DISTANCE==null?"0":""+DISTANCE);
        if (null!=XLTYPE){
