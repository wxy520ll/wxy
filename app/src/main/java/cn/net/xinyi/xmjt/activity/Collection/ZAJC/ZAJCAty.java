 ...
 */
public class ZAJCAty extends BaseWithLocActivity implements IZAJCView,View.OnClickListener,RadioGroup.OnCheckedChangeListener {
    /**采集类别**/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_zabase);
        /***注解式绑定控件**/
    ...
    private void initData() {
        ...
        /**楼栋编码记录本地数据提示**/
        BaseDataUtils.initAutoComplete(ZAJCAty.this,"history","440307005", et_ldbm);
        /***从业者 数据集合*/
        ...
        tv_type.setText(getIntent().getStringExtra("cjfl"));
        tv_lb.setText(getIntent().getStringExtra("lb"));
    ...
    public void onClick(View v) {
        switch (v.getId()){
                        ...
                        new AlertDialog.Builder(this).setTitle("提示")
                                ...
                                .setNegativeButton ("查看详情",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                                int which) {
                                                Intent intent = new Intent(ZAJCAty.this,ZAJCLocalAty.class);
                                ...
                                .setPositiveButton("继续采集",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                                int which) {
                                                Intent intent = new Intent(ZAJCAty.this, ZAJCAty.class);
                                                intent.putExtra("cjfl",getCJFL());
                                                intent.putExtra("lb",getLB());
                                                startActivity(intent);
                                                ZAJCAty.this.finish();
                                            }
            ...
            case R.id.btn_upl:
                ...
                String msg1=getMsg();
                if(!msg1.isEmpty()) {
                    BaseUtil.showDialog(msg1, ZAJCAty.this);
                }else {
                    ...
                    if (zajcModle != null && cyyModles.size()!=0){
                        if (((AppContext) getApplication()).getNetworkType()!=1){
                            ...
                            DialogHelper.showAlertDialog(getResources().getString(R.string.upload_no_wifi_tips), ZAJCAty.this, new DialogHelper.OnOptionClickListener() {
                                @Override
    ...
    @Override
    public String getLB() {
        return tv_lb.getText().toString().trim();
    }
    ...
    private Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 1:// 上传进度条显示
                    mProgressDialog = new ProgressDialog(ZAJCAty.this);
                ...
                case 2:// 上传之后
                    ...
                    new AlertDialog.Builder(ZAJCAty.this).setTitle("提示")
                            .setMessage("上传成功!")
                ...
                case 3:// 上传失败
                    mProgressDialog.cancel();
                    BaseUtil.showDialog("上传失败，可能当前上传的人数较多，请稍候重试！",ZAJCAty.this);
                    break;
                case 4://上传检测完成
                    mProgressDialog.cancel();
                    if (msg.arg1 == 0) {
                        BaseUtil.showDialog("系统检测到当前APP 版本过低，请回到民警通主菜单点击【系统设置】-【APP 更新】，按提示升级APP 后重新上传！", ZAJCAty.this);
                    }
                    break;
            }
        }
    ...
    private void initCYZAdapt(final List<ZAJCCYZModle> cyyModles) {
        if (cyyModles.size()!=0){
            ...
            boolean bflag=false;
            ZAJCCYZAdp mAdapter=new ZAJCCYZAdp(bflag,lv_cyz,cyyModles,R.layout.aty_zacyz_item,ZAJCAty.this);
            lv_cyz.setAdapter(mAdapter);
            lv_cyz.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(ZAJCAty.this, ZAJCCYZWatchAty.class);
            ...
            mAdapter.setonClickListener(new ZAJCCYZAdp.onClickListener() {
                ...
                public void onDel(final int index) {
                    new AlertDialog.Builder(ZAJCAty.this)
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getAction() == KeyEvent.ACTION_DOWN
            ...
            new BaseDataUtils().loginOut(ZAJCAty.this);
        }
