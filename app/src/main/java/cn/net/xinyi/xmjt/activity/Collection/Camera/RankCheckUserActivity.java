 ...
 * 每日用户采集排名
 */
public class RankCheckUserActivity extends BaseActivity  {
    private static final String TAG = RankCheckUserActivity.class.getName();

    private ListView mListView;
    private RankUploadUserAdapter mAdapter;
    private JSONArray mArray;
    private ProgressDialog mProgressDialog = null;
    private TextView txt_count_title;
    private int flag=1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle("用户每日核查统计");
    ...
    private void initResource() {
        ...
        txt_count_title = (TextView) findViewById(R.id.txt_count_title);
        txt_count_title.setText("核查数");
    }

    private void initListView() {
        mAdapter = new RankUploadUserAdapter(this, mArray,flag);
    ...
    private void getCount() {
        ...
        ApiResource.getUserCheckCount(username, new AsyncHttpResponseHandler() {
            @Override
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    if (mProgressDialog != null && mProgressDialog.isShowing())
                        mProgressDialog.cancel();
                    BaseUtil.showDialog("获取数据失败", RankCheckUserActivity.this);
                    break;
                default:
                    break;
            }
