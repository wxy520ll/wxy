 ...
 */
public class ZacsAty2 extends BaseWithLocActivity implements IZAJCView, View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    /**
     * 采集分类
     **/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_zacs2);
        /***注解式绑定控件**/
    ...
    public void onClick(View v) {
        switch (v.getId()) {
                        ...
                        new AlertDialog.Builder(this).setTitle("提示")
                                ...
                                .setNegativeButton("查看详情",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                                int which) {
                                                Intent intent = new Intent(ZacsAty2.this, ZAJCLocalAty.class);
                                                startActivity(intent);
                                                ZacsAty2.this.finish();
                                            }
                                        })
                                .setPositiveButton("继续采集",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                                int which) {
                                                Intent intent = new Intent(ZacsAty2.this, ZacsAty2.class);
            ...
            case R.id.btn_upl:
                ...
                String msg1 = getMsg();
                if (!msg1.isEmpty()) {
                    BaseUtil.showDialog(msg1, ZacsAty2.this);
                } else {
                    ...
                    if (zajcModle != null) {
                        if (((AppContext) getApplication()).getNetworkType() != 1) {
                            ...
                            DialogHelper.showAlertDialog(getResources().getString(R.string.upload_no_wifi_tips), ZacsAty2.this, new DialogHelper.OnOptionClickListener() {
                                @Override
    ...
    private String getMsg() {
        ...
        int index = -1;
        final Object tag = tv_type.getTag();
        if (tag != null) {
            index = Integer.valueOf((String) tag);
        } else {
            index = Integer.parseInt(zdUtils.getZdlbAndZdzToZdbm(GeneralUtils.XXCJ_ZAJCFL_JT_NEW, tv_type.getText().toString()));
        }
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:// 上传进度条显示
                    mProgressDialog = new ProgressDialog(ZacsAty2.this);
                ...
                case 2:// 上传之后
                    ...
                    new AlertDialog.Builder(ZacsAty2.this).setTitle("提示")
                            .setMessage("上传成功!")
                ...
                case 3:// 上传失败
                    mProgressDialog.cancel();
                    BaseUtil.showDialog("上传失败，可能当前上传的人数较多，请稍候重试！", ZacsAty2.this);
                    break;
                case 4://上传检测完成
                    mProgressDialog.cancel();
                    if (msg.arg1 == 0) {
                        BaseUtil.showDialog("系统检测到当前APP 版本过低，请回到民警通主菜单点击【系统设置】-【APP 更新】，按提示升级APP 后重新上传！", ZacsAty2.this);
                    }
                    break;
            }
        }
    ...
    private void initCYZAdapt(final List<ZAJCCYZModle> cyyModles) {
        if (cyyModles.size() != 0) {
            ...
            boolean bflag = false;
            ZAJCCYZAdp mAdapter = new ZAJCCYZAdp(bflag, lv_cyz, cyyModles, R.layout.aty_zacyz_item, ZacsAty2.this);
            lv_cyz.setAdapter(mAdapter);
            lv_cyz.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(ZacsAty2.this, ZAJCCYZWatchAty.class);
            ...
            mAdapter.setonClickListener(new ZAJCCYZAdp.onClickListener() {
                ...
                public void onDel(final int index) {
                    new AlertDialog.Builder(ZacsAty2.this)
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getAction() == KeyEvent.ACTION_DOWN
            ...
            new BaseDataUtils().loginOut(ZacsAty2.this);
        }
