 ...
 */
public class RankJDAdapter extends BaseAdapter {
    private JSONArray data=null;
    private Context context;

    public RankJDAdapter(Context context, JSONArray data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String pcs =((JSONObject)data.get(position)).getString("SSJD");
