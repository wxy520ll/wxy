...
import cn.net.xinyi.xmjt.activity.Plate.Adapter.LpnOrganRankAdapter;
import cn.net.xinyi.xmjt.api.ApiResource;
import cn.net.xinyi.xmjt.config.BaseActivity;
import cn.net.xinyi.xmjt.utils.BaseUtil;
import cn.net.xinyi.xmjt.utils.DateUtil;

public class LpnOrganRankActivity extends BaseActivity implements View.OnClickListener {
    public static final String TAG = LpnOrganRankActivity.class.getName();
    private String type[] = new String[]{"全部", "一类所", "二类所", "三类所"};
    private TextView tv_choose_start_date;
    private TextView tv_choose_end_date;
    private TextView tv_choosetype;
    private ListView mListView;
    private LpnOrganRankAdapter rankAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_policerank);
        setViews();
        getRank();

        getActionBar().setIcon(R.drawable.actionbar_back_icon_normal);
        getActionBar().setTitle("单位上传排行");
    ...
    private void setViews() {
        ...
        //选择类型
        tv_choosetype = (TextView) findViewById(R.id.tv_choosetype);
        tv_choosetype.setOnClickListener(this);
        tv_choosetype.setText("全部");
    ...
    private void getRank(){
        ...
        if(!tv_choosetype.getText().toString().trim().equals("全部")){
            jo.put("organtype",tv_choosetype.getText().toString().trim());
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    if (mProgressDialog != null && mProgressDialog.isShowing())
                        mProgressDialog.cancel();
                    BaseUtil.showDialog("获取数据失败", LpnOrganRankActivity.this);
                    break;
                default:
                    break;
            }
    ...
    private void initListView(){
        rankAdapter = new LpnOrganRankAdapter(this, rankArray,days);
        ...
        switch (v.getId()){
            ...
            case  R.id.tv_choose_start_date:
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        LpnOrganRankActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view,
                        ...
                        try {
                            ...
                            if (choose_start_date<init_date){
                                Toast.makeText(LpnOrganRankActivity.this, "开始日期不能小于2015-08-26",Toast.LENGTH_SHORT).show();
                                //结束时间和开始时间进行比较
                            } else if (choose_end_date<choose_start_date){
                                Toast.makeText(LpnOrganRankActivity.this, "开始日期不能大于结束日期",Toast.LENGTH_SHORT).show();
                            }else{
                ...
                builder.setItems(type,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                tv_choosetype.setText(type[which]);
                                getRank();
                            }
                        });
                builder.create().show();
