 ...
 */
public class DutyTotalDetailsAty extends BaseListAty {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (null==((JSONObject)rankArray.get(position)).getString("XLDID")){
                    Intent intent = new Intent(DutyTotalDetailsAty.this,DutyBoxAddAty.class);
                    intent.putExtra("extra",((JSONObject)rankArray.get(position)).toJSONString());
                    intent.putExtra("isPeople",true);
                    intent.setFlags(1);
                    startActivity(intent);
                }else{
                    Intent intent=new Intent(DutyTotalDetailsAty.this,DutyOperHistoryAty.class);
    ...
    protected void requestData() {
        showLoadding();
        ApiResource.getDutyPCSDetailsXQ(getRequest(), new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (rankArray.size() > 0){
                    setHasData();
                    DutyTotalDetailsAdp adp = new DutyTotalDetailsAdp(DutyTotalDetailsAty.this,rankArray);
                    adp.setOnPeopleClickListener(new DutyTotalDetailsAdp.OnPeopleClickListener() {
                        @Override
                        ...
                        public void onFlightRults(View view, JSONObject jsonObject) {
                            if (null ==  jsonObject.getString("XLDID")){//处警状态
                                ...
                                Intent intent = new Intent(DutyTotalDetailsAty.this,DutyFlightsAty.class);
    ...
    public void setupTopView(LinearLayout parent) {
        ...
        View addView= LayoutInflater.from(this).inflate(R.layout.aty_duty_total_details,parent);
...
//                String [] levels=new String[]{"全部","一级","二级","三级","视频"};
                BaseDataUtils.showAlertDialog(DutyTotalDetailsAty.this,getResources().getStringArray(R.array.duty_level),tv_beatlevel);
            }
        });
