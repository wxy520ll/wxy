 ...
 */
public class RankJDUserActivity extends BaseActivity implements View.OnClickListener {
    public static final String TAG = RankJDUserActivity.class.getName();
    ...
    private int days = 0;
    private TextView tv_choose_jd;


    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.rank_jd_user);
        setViews();
        getRank();

        getActionBar().setIcon(R.drawable.actionbar_back_icon_normal);
        getActionBar().setTitle("街道办用户采集排名");
    ...
    private void setViews() {
        ...
        tv_choose_jd.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    private void getRank(){
        ...
        if(!tv_choose_jd.getText().toString().trim().isEmpty()){
            jo.put("jd", tv_choose_jd.getText().toString().trim());
        }
        ...
        ApiResource.JDUserrank(json, new AsyncHttpResponseHandler() {
            @Override
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    if (mProgressDialog != null && mProgressDialog.isShowing())
                        mProgressDialog.cancel();
                    BaseUtil.showDialog("获取数据失败", RankJDUserActivity.this);
                    break;
                default:
                    break;
            }
        ...
        switch (v.getId()){
            ...
            case  R.id.tv_choose_start_date:
                ...
                new DatePickerDialog(
                        RankJDUserActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view,
                        ...
                        try {
                            ...
                            if (choose_start_date<init_date){
                                Toast.makeText(RankJDUserActivity.this, "开始日期不能小于2015-10-26",Toast.LENGTH_SHORT).show();
                                //结束时间和开始时间进行比较
                            } else if (choose_end_date<choose_start_date){
                                Toast.makeText(RankJDUserActivity.this, "开始日期不能大于结束日期",Toast.LENGTH_SHORT).show();
                            }else{
