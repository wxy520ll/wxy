 ...
 */
public class RankPCSUserCheckActivity extends BaseActivity implements View.OnClickListener {
    public static final String TAG = RankPCSUserCheckActivity.class.getName();
    ...
    private TextView completed_number;
    private int flags=1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle("派出所用户核查排名");
    ...
    private void setViews() {
        ...
        completed_number=(TextView)findViewById(R.id.completed_number);
        completed_number.setText("核查数");
    ...
    private void getRank(){
        ...
        ApiResource.PCSUserCheckrank(json, new AsyncHttpResponseHandler() {
            @Override
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    if (mProgressDialog != null && mProgressDialog.isShowing())
                        mProgressDialog.cancel();
                    BaseUtil.showDialog("获取数据失败", RankPCSUserCheckActivity.this);
                    break;
                default:
                    break;
            }
    ...
    private void initListView(){
        rankAdapter = new RankPCSUserAdapter(this, rankArray,days,flags);
        ...
        switch (v.getId()){
            ...
            case  R.id.tv_choose_start_date:
                ...
                new DatePickerDialog(
                        RankPCSUserCheckActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view,
                        ...
                        try {
                            ...
                            if (choose_start_date<init_date){
                                Toast.makeText(RankPCSUserCheckActivity.this, "开始日期不能小于2015-10-26",Toast.LENGTH_SHORT).show();
                                //结束时间和开始时间进行比较
                            } else if (choose_end_date<choose_start_date){
                                Toast.makeText(RankPCSUserCheckActivity.this, "开始日期不能大于结束日期",Toast.LENGTH_SHORT).show();
                            }else{
