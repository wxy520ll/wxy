 ...
 */
public class PerRetRankUserAty extends BaseActivity implements View.OnClickListener {
    public static final String TAG = PerRetRankUserAty.class.getName();
    ...
    private void getRank(){
        ...
        ApiResource.PerUserRank(json, new AsyncHttpResponseHandler() {
            @Override
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 2:
                    if (mProgressDialog != null && mProgressDialog.isShowing())
                        mProgressDialog.cancel();
                    BaseUtil.showDialog("获取数据失败", PerRetRankUserAty.this);
                    break;
                default:
                    break;
            }
        ...
        switch (v.getId()){
            ...
            case  R.id.tv_choose_start_date:
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        PerRetRankUserAty.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view,
                        ...
                        try {
                            ...
                            if (choose_start_date<init_date){
                                Toast.makeText(PerRetRankUserAty.this, "开始日期不能小于2015-08-26",Toast.LENGTH_SHORT).show();
                                //结束时间和开始时间进行比较
                            } else if (choose_end_date<choose_start_date){
                                Toast.makeText(PerRetRankUserAty.this, "开始日期不能大于结束日期",Toast.LENGTH_SHORT).show();
                            }else{
